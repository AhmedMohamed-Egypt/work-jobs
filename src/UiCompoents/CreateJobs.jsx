...
function CreateJobs() {
    ...
    return (
        <div className="pl-5 bg-white border border-[#E0DFDC] p-4 py-5 pb-8 my-8 rounded-xl">
            ...
            <div>
                <ButtonDefault onClick={()=>navigate('/CreationJobs')} classes={{root:'!px-6 !h-auto !bg-[#000] !font-roboto !rounded-full !font-normal' ,label:'!text-white !py-[7px]  !text-base'}} text={'Create New Jobs'}/>
